    ...
    admtype: {
      bolus: {
        ...
        doseOptions: [
          {
            id: 'iot',
            label: 'Intubação Orotraqueal - SRI (1 - 3 mcg/kg)',
            min: 1,
            max: 3,
            step: 0.01,
            unit: 'mcg/kg'
        ...
        dose: { min: 1, max: 3, step: 0.1, unit: 'mcg/kg' }
      },
      infusion: {
    ...
    admtype: {
      infusion: {
        doseOptions: [
          {
            id: 'padrao',
            label: 'Dose Padrão (0.2-1.4 µg/kg/h)',
            min: 0.2,
            max: 1.4,
            step: 0.1,
            unit: 'µg/kg/h'
          ...
          {
            id: 'pos-operatorio',
            label: 'Pós-Operatório (0.4-0.8 µg/kg/h)',
            min: 0.4,
            max: 0.8,
            step: 0.1,
            unit: 'µg/kg/h'
