...
export const medicationsDB = {
  ...
  dexmedetomidina: {
    ...
    admtype: {
      infusion: {
        doseOptions: [
          { id: 'padrao', label: 'Dose Padrão (0.2-1.4 mcg/kg/h)', min: 0.2, max: 1.4, step: 0.1, unit: 'mcg/kg/h' },  
          { id: 'pos-operatorio', label: 'Pós-Operatório (0.4-0.8 mcg/kg/h)', min: 0.4, max: 0.8, step: 0.1, unit: 'mcg/kg/h' }
        ],
        dose: { min: 0.2, max: 1.4, step: 0.1, unit: 'mcg/kg/h' },
        diluicoes: [
          { label: 'Diluição 50mL', medVolume: 2, solVolume: 50, concValue: 4, concUnit: 'mcg/mL' },
          { label: 'Diluição 100mL', medVolume: 4, solVolume: 100, concValue: 4, concUnit: 'mcg/mL' }
        ]
      }
    }
  },
